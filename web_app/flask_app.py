...
sys.path.append('/home/mcian91/news_analysis/working_with_data2')
...
sys.path.append('/home/mcian91/news_analysis/web_app')
...
def get_components(topic):
    with open('/home/mcian91/news_analysis/web_app/static/img/bokeh_plots/components_dict_'+identifier+'.pkl', 'rb') as f:
...
def get_article(url):
    try:
        ...
        while a.html == '' and attempt < 10:
            ...
            attempt += 1
        if attempt >= 10:
            print('Article would not download after 10 attempts!')
            return False, ()
...
@app.route('/')
def index():
    vis_plot = codecs.open("/home/mcian91/news_analysis/web_app/static/img/pyLDAvis_graphs/pyLDAvis_2017-06-18_55_topics_400_passes.html", 'r')
...
def graphs():
    with open('/home/mcian91/news_analysis/pickles/lda_model_'+identifier+'.pkl', 'rb') as f:
        lda_model = pickle.load(f)
    vis_plot = codecs.open("/home/mcian91/news_analysis/web_app/static/img/pyLDAvis_graphs/pyLDAvis_"+identifier+".html", 'r')
    pyLDAvis_html = vis_plot.read()
...
if __name__ == '__main__':
    app.run(host='0.0.0.0', port=8106, debug=True)flask_app
